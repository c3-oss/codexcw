...
//
// The package starts codex exec --json, Claude Code stream-json, or Grok Build
// streaming-messages-json as a child process, streams decoded
// events through channels or handlers, and keeps raw JSON payloads available
// for callers that need fields not yet modeled by typed helpers. Claude and
// Grok events are normalized into the same Event model.
//
